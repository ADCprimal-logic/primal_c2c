<template>
    ...
    <v-layout justify-center>
        <material-card color="bluebird"
                       elevation="12"
                       title="Welcome to the Front Desk Login Portal!"
                       height="400"
                       width="400">
            <v-card-text>
                <v-form>
        ...
        <v-snackbar :color="color1"
            ...
            <div>Incorrect Portal. Please log into the <u>Admin</u> Portal</div>
            <v-icon size="16"
            ...
            async userLogin() {
                ...
                try {
                    ...
                    if (responseLogin.status === 200) {
                        ...
                        if (responseUser.decoded.parsedRole === 2) {
                            await this.setUsername(responseUser.decoded.name);
                            this.$router.push({ path: "Front-Desk-Dashboard" });
