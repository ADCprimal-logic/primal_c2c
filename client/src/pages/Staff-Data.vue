          ...
          >
            ...
            <template v-slot:items="props">
              <tr>
                ...
                <td class="text-xs-left" v-if="props.item.role === 1">
                  General
                </td>
                <td class="text-xs-left" v-else-if="props.item.role === 2">
                  Front-Desk
                </td>
                <td class="text-xs-left" v-else-if="props.item.role === 3">
                  Director
                </td>
                      ...
                      <v-card color="C2Cblue">
                        ...
                        <v-list two-line>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >(650) 555-1234</v-list-tile-title
                              >
                              <v-list-tile-sub-title>
                                Guardian Full Name / Guardian Mobile Number
                              </v-list-tile-sub-title>
                            </v-list-tile-content>
                          </v-list-tile>
                          <!-- Field Divider -->
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >(323) 555-6789</v-list-tile-title
                              >
                              <v-list-tile-sub-title>
                                Guardian Full Name / Guardian Mobile Number
                              </v-list-tile-sub-title>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >Some medication is imported
                                here</v-list-tile-title
                              >
                              <v-list-tile-sub-title
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              ...
                              >
                              <v-list-tile-sub-title
                                >Homeroom</v-list-tile-sub-title
                              >
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-divider inset></v-divider>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              ...
                              >
                              <v-list-tile-sub-title>
                                Click here to expand immuniziations
                              </v-list-tile-sub-title>
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-divider inset></v-divider>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >Approved Contacts</v-list-tile-title
                              >
                              <v-list-tile-sub-title
