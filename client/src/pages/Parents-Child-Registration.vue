                ...
                <v-stepper-content step="1">
                    <validation-observer ref="observer" v-slot="{ invalid }">
                        <form @submit.prevent="submit">
                            ...
                            <v-btn outlined @click="e6 = 2; radioGroup = ''" color="accent"> Add a new Child </v-btn>
                        </form>
                    </validation-observer>
                </v-stepper-content>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async createChild() {
                console.log("parent id from local: " + this.myParentID);
                const { data } = await graphql(CREATE_CHILD, {
                    ...
                    myParent: { connect: { id: this.myParentID } },
                });
                this.childid = data;
            ...
            determineLocation() {
                if (this.thislocation == 'Greenville') {
                    ...
                    } else if (this.thisprogram == 'Drop-In Attendance (Summer Camp Only)') {
                        this.finalLocationID = 4;
                    } else if (this.thisprogram == 'Summer Camp Only (2021)') {
                        this.finalLocationID = 5;
                    } else if (this.thisprogram == 'Annual Contract (June 2021 - May 2022)') {
                ...
                this.disconnectLocationFromChild();
            },
            async disconnectLocationFromChild() {
                await graphql(UPDATE_CHILD_LOCATION, {
                    myChild: this.radioGroup,
                    myLocation: { connect: { id: this.finalLocationID } },
                });
                console.log("disconnect location ran");
            ...
            async connectLocation2Child() {
                ...
                console.log("child ID: " + this.radioGroup + " /// locationID: " + this.finalLocationID);
            },
            clear() {
                this.name = "";
                this.phoneNumber = "";
