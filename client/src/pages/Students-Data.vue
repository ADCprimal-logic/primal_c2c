          ...
          >
            ...
            <template v-slot:items="props">
              <tr @click="props.expanded = !props.expanded">
                ...
                <td class="text-xs-left" v-else>n/a</td>
                <td class="text-xs-left" v-if="props.item.medical_record">
                  {{ props.item.medical_record.allergies }}
                </td>
                <td class="text-xs-left" v-else>n/a</td>
                    ...
                    <v-flex xs12 sm6 offset-sm3>
                      <v-card color="C2Cblue">
                        ...
                        <v-list two-line>
                          ...
                          <v-list-tile
                            @click=""
                            v-for="value in props.item.parent"
                          >
                            <v-list-tile-action>
                              <v-icon color="C2Corange"
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title v-if="props.item.parent">{{
                                value.full_name
                              }}</v-list-tile-title>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                v-if="props.item.medical_record"
                                >{{
                                  props.item.medical_record.medications
                                }}</v-list-tile-title
                              >
                              <v-list-tile-title v-else>n/a</v-list-tile-title>
                              <v-list-tile-sub-title
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              ...
                              <v-list-tile-title v-else>n/a</v-list-tile-title>
                              <v-list-tile-sub-title
                                >Known Allergies</v-list-tile-sub-title
                              >
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-divider inset></v-divider>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >Tuition Paid: () Tuition Owed:
                                ()</v-list-tile-title
                              >
                              <v-list-tile-sub-title
                                >Balance</v-list-tile-sub-title
                              >
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-divider inset></v-divider>
                          ...
                          <v-list-tile @click="">
                            <v-list-tile-action>
                              <v-icon color="C2Corange"
                                >mdi-hospital-marker</v-icon
                              >
                            </v-list-tile-action>

                            <v-list-tile-content>
                              <v-list-tile-title v-if="props.item.location">{{
                                props.item.location.name
                              }}</v-list-tile-title>
                              <v-list-tile-title v-else>n/a</v-list-tile-title>
                              <v-list-tile-sub-title
                                >Camp Location</v-list-tile-sub-title
                              >
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-divider inset></v-divider>
                          ...
                          <v-list-tile @click="">
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title
                                >Immuniziations</v-list-tile-title
                              >
                              <v-list-tile-sub-title>
                                Future Update
                              </v-list-tile-sub-title>
                          ...
                          <v-list-tile
                            @click=""
                            v-for="value in props.item.approved_contact"
                          >
                            <v-list-tile-action>
                              <v-icon color="C2Corange"
                            ...
                            <v-list-tile-content>
                              <v-list-tile-title v-if="value.full_name">{{
                                value.full_name
                              }}</v-list-tile-title>
                              <v-list-tile-title v-else>n/a</v-list-tile-title>
                              <!--
                                                            ...
                                                            -->
                              <v-list-tile-sub-title
                                >Approved Contact</v-list-tile-sub-title
                              >
                            </v-list-tile-content>
                          </v-list-tile>
                          <v-list-tile>
...
function makeDate() {
  ...
  if (currentMonth < 10) {
    dateString = dateString + "0" + (currentMonth + 1) + "-";
  } else {
    dateString = dateString + (currentMonth + 1) + "-";
  }
  const currentDayOfMonth = currentDate.getDate();
  if (currentDayOfMonth < 10) {
    dateString = dateString + "0" + currentDayOfMonth;
  } else {
    dateString = dateString + currentDayOfMonth;
  }
